...
public class ItemRepositoryTest {
    ...
    class FindByOwnerIdTests {
        ...
        void findByOwnerIdTest() {
            List<Item> found = repository.findByOwnerIdOrderById(user.getId(), Pageable.ofSize(10));
            assertThat(found).isNotEmpty();
            verify(found.get(0), item);
        }
        ...
        void findByOwnerIdNotFoundTest() {
            List<Item> found = repository.findByOwnerIdOrderById(user2.getId(), Pageable.ofSize(10));
            assertThat(found).isEmpty();
        }
    }
